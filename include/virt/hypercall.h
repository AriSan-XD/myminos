...
#define HVC_MOAT_SWITCH_TO		    HVC_MOAT_FN(4)
#define HVC_MOAT_SWITCH_BACK	    HVC_MOAT_FN(5)
#define HVC_MOAT_MEMCPY			    HVC_MOAT_FN(6)
#define HVC_MOAT_MAYBE_SWITCH_BACK  HVC_MOAT_FN(7)
#define HVC_MOAT_IRQ_SWITCH_TO  	HVC_MOAT_FN(8)
#define HVC_MOAT_IRQ_SWITCH_BACK	HVC_MOAT_FN(9)
